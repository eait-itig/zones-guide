...
command (changing `uqfoo` to your UQ username) to create this file:

....
mkdir ~/.ssh && printf "Host *.zones.eait.uq.edu.au\n  ProxyJump uqfoo@moss.labs.eait.uq.edu.au" > ~/.ssh/config
....
