...
Creating instance 3a6ae279 (3a6ae279-30f6-4ad6-bc0c-48b1f345ac6d, jupyter@20250225)
Created instance 3a6ae279 (3a6ae279-30f6-4ad6-bc0c-48b1f345ac6d) in 1m1s
....

Then open https://3a6ae279.uqcloud.net in a web browser.

=== Changing between Jupyter Notebook (classic) and JupyterLab

=== Installing Python packages

Open a Jupyter terminal and use `pip install`. Don't use `sudo`.

=== Installing R packages

Install from CRAN with `apt-get`, the PPA is added to the image.
